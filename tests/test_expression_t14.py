...
@pytest.mark.parametrize(
    ...
    [
        # ① 퀴즈 앵커
        # ① 퀴즈 앵커 — T16 부터 서버 큐가 열고 닫는다. T21-A 에서 «알림을 말로 해라» 를 뺐다가 하네스 1420(큐 5개 중 2개
        #   무선언 진행)으로 한 절 되살렸다 — 학습자가 퀴즈인지 알아야 한다.
        ...
        "따라 말하게 해라 — **그리고 거기서 멈추고 기다려라.** 다음 문제는 학습자가 따라 말한 다음 턴에 낸다",
        "정답을 들려준 뒤에는 '어떻게 말해요?' 로 되묻지 마라",
        # ⑤ 격식
        "반말로 답하면 맞힌 게 아니다",
