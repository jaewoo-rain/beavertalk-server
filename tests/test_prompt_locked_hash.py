...
FROZEN_FN: dict[str, tuple[str, object]] = {
    ...
    "seeds.expression_quiz_verdict_instruction": ("95b6cd42e982fa4f", lambda: seeds.expression_quiz_verdict_instruction(["1. 물 — 뜻: water"], target="한국어", locale_label="영어(English)")),   # 2026-09-15 4차 B
