...
FROZEN_FN: dict[str, tuple[str, object]] = {
    ...
    "seeds.expression_quiz_cue": ("99edd81e0b6cfc3c", lambda: seeds.expression_quiz_cue("«물» «가다»", 2, retry=False, locale_label="영어(English)", target="한국어")),
    ...
    "expression.procedure": ("e9591ff51462b772", lambda: lex.procedure(drill_intro="- 드릴: {target}/{locale_label}", target="한국어", locale_label="영어(English)", has_grammar=True)),
