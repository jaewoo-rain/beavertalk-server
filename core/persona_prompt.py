...
def _study_procedure(is_l1: bool, *, target: str) -> str:
    ...
    if is_l1:
        return "\n".join([
            ...
            f'마라 — "{target}에서는 그냥 이렇게 말한다"로 충분하다.' + _STUDY_NEXT_TAIL,
            "- 단어: ① 뜻을 알려 주고 ② 단어를 또박또박 따라 말하게 "
            "③ 가능하면 오늘의 통문장에 끼워 한 번 더 통째로 따라 말하게 해라." + _STUDY_NEXT_TAIL,
            _STUDY_STATE_PROCEDURE,
        ])
    return "\n".join([
        "유형별 절차:",
