...
def select_items(
    ...
    복습 채움 규칙 그대로), **오답**(failed) 항목은 이번 통화 안에서 다시 싣는다. 새 통화는 둘 다 비어 있어 종전과 같다.
